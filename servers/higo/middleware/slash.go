...
func AddTrailingSlash() higo.MiddlewareFunc {
...
func AddTrailingSlashWithConfig(config TrailingSlashConfig) higo.MiddlewareFunc {
	// Defaults
...
func RemoveTrailingSlash() higo.MiddlewareFunc {
...
func RemoveTrailingSlashWithConfig(config TrailingSlashConfig) higo.MiddlewareFunc {
	// Defaults
	if config.Skipper == nil {
		config.Skipper = DefaultTrailingSlashConfig.Skipper
	}
