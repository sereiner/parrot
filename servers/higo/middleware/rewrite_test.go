...
func TestEchoRewritePreMiddleware(t *testing.T) {
	...
	// Route
	r.Add(http.MethodGet, "/new", func(c higo.Context) error {
...
func TestRewriteWithConfigPreMiddleware_Issue1143(t *testing.T) {
	...
	r.Add(http.MethodGet, "/api/:version/hosts/:name", func(c higo.Context) error {
		return c.String(200, "hosts")
	})
	r.Add(http.MethodGet, "/api/:version/eng", func(c higo.Context) error {
